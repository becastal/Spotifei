...
import com.mycompany.spotifei.control.LoginController;
	...
	@SuppressWarnings("unchecked")
		...
		try {
			if (controller.autenticar(email, senha)) {
				new Menu(controller.queryEmail(email)).setVisible(true);
				dispose();
			...
			JOptionPane.showMessageDialog(this, "Erro no SQL: " + ex.getMessage());
		}
